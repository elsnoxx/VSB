...
/*	DD S15 L01
o	Napi�te dotaz pro spojov�n� �et�zc� pomoc� || , pomoc� CONCAT()*/
...
o	T��d�n� podle jednoho nebo vice atribut� */
...
/*o	Jedno��dkov� funkce
o	v�ce��dkov� funkce MIN, MAX, AVG, SUM, COUNT */
...
/*v�ce��dkov� funkce MIN, MAX, AVG, SUM, COUNT*/
...
/*o	Pou�ijte tabulku DUAL
o	SQL S01 L02
�	SQL S01 L02
o	ROUND, TRUNC zaukrouhlen� na 2 desetinn� m�sta, na cel� tis�ce MOD
...
/*�	SQL S03 L04
o	Spojov�n� 2x stejn� tabulky s p�ejmenov�n�m (vazba mezi nad��zen�mi a pod��zen�mi v jedn� tabulce)
o	Hierarchick� dotazov�n� � stromov� struktura zano�en� START WITH, CONNECT BY PRIOR, LEVEL
...
o	Rozd�l mezi COUNT (*) a COUNT (atribut)
o	Pro� NVL u agrega�n�ch funkc� */
...
/*�	SQL S05 L03
o	Mno�inov� operace v SQL � UNION, UNION ALL, INTERSECT, MINUS
o	ORDER BY u mno�inov�ch operac�*/
...
/*o	Vno�en� dotazy
o	V�sledek jako jedin� hodnota
o	V�cesloupcov� poddotaz
o	EXISTS, NOT EXISTS */
...
/*�	SQL S06 L03
o	V�ce��dkov� poddotazy IN, ANY, ALL
...
VALUES (6,'Jana','Machov�','+420605311565','Jana.Machova@hilite.com',TO_DATE('06/03/1990', 'DD/MM/YYYY'),'900306/5321','Accountant',1,
'MAC211',TO_DATE('03/03/2018', 'DD/MM/YYYY'),TO_DATE(NULL),CURRENT_DATE,5,1);

INSERT INTO employee 
VALUES (7,'Margita','Mal�','+420732693693','Margita.Mala@msa.com',TO_DATE('06/11/1976', 'DD/MM/YYYY'),'761106/5020','HR generalist',1,
...
/*o	Objekty v datab�z� � Tabulky, Indexy, Constraint, View, Sequnce, Synonym
...
-- o	Ciz� kl��e, ON DELETE, ON UPDATE, RESTRICT, CASCADE atd.
...
/*
�	SQL S11 L03
o	INLINE VIEW Poddotaz v podob� tabulky SELECT atr FROM (SELECT * FROM Tab) alt_tab */
...
/*
o	Jak� pr�va lze p�id�lit na jak� objekty? (ALTER, DELETE, EXECUTE, INDEX, INSERT, REFERENCES, SELECT, UPDATE) � (TABLE, VIEW, SEQUENCE, PROCEDURE)
�	SQL S13 L03
o	Regul�rn� v�razy
...
/*
�	SQL S15 L01
o	Alternativn� z�pis spojov�n� bez JOIN s podm�nkou spojen� ve WHERE
o	Lev� a prav� spojen� s pomoc� atrA = atrB (+)
*/
