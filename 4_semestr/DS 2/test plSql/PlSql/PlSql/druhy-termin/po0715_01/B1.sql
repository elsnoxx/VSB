...
BEGIN
    ...
    FOR v_pohlavi IN  (
        ...
        EXECUTE IMMEDIATE 'INSERT INTO ' ||  v_tableName || ' (jmeno, prijmeni, narozeni) SELECT jmeno, prijmeni, narozeni FROM OSOBA WHERE POHLAVI = :1 AND NAROZENI BETWEEN :2 AND :3' USING v_pohlavi.POHLAVI, p_fromDate, p_untilDate;
