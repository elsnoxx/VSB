...
\end{verbatim}
    ...
    \begin{itemize}
        \item Aktualizuj záznam v tabulce Reservation – nastav nový room\_id:
\begin{verbatim}
UPDATE Reservation
...
\end{verbatim}
    \end{itemize}
    \item \textbf{Aktualizace ceny ubytování:}
    \begin{itemize}
        \item Spočítej novou cenu pomocí funkce getPriceOfAccommodation.
        \item Aktualizuj platbu:
\begin{verbatim}
UPDATE Payment
SET total_accommodation = :newTotal
