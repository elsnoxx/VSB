...
tests = []
tests.append({'name': 'test0', 'title': 'output1', 'exit_code': 0, 'args': ['source1.bin'], 'stdin': None, 'stdout': None, 'stderr': None, 'files_in': ['source1.bin'], 'files_out': ['customers.json', 'customers.xml']})
tests.append({'name': 'test1', 'title': 'output2', 'exit_code': 0, 'args': ['source2.bin'], 'stdin': None, 'stdout': 'stdout', 'stderr': None, 'files_in': ['source2.bin'], 'files_out': ['customers.json', 'customers.xml']})
