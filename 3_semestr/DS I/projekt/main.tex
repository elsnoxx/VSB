...
\begin{itemize}
    \item \textbf{Address} – \underline{address\_id}, street, city, postal\_code, country
    \item \textbf{Guest} – \underline{guest\_id}, firstname, lastname, email, phone, birth\_date, \textit{address\_id}, guest\_type, registration\_date, notes
    \item \textbf{Employee} – \underline{employee\_id}, firstname, lastname, position, \textit{address\_id}
    \item \textbf{RoomType} – \underline{room\_type\_id}, name, bed\_count, price\_per\_night
    \item \textbf{Room} – \underline{room\_id}, \textit{room\_type\_id}, room\_number, is\_occupied
    \item \textbf{Payment} – \underline{payment\_id}, total\_accommodation, total\_expenses, payment\_date, is\_paid
    \item \textbf{Reservation} – \underline{reservation\_id}, \textit{guest\_id}, \textit{room\_id}, \textit{employee\_id}, creation\_date, check\_in\_date, check\_out\_date, \textit{payment\_id}, status
\end{itemize}
