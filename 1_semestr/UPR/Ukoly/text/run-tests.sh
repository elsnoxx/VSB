...
then
  ...
  execute_test 'test-empty' $'' '0'
  execute_test 'test-spaces' $'' '0'
  execute_test 'test-max-chars' $'' '0'
  execute_test 'test-consecutive' $'' '0'
  execute_test 'test-simple' $'' '0'
  execute_test 'test-medium' $'' '0'
  execute_test 'test-large' $'' '0'
